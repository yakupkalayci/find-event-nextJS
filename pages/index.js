      ...
      <div className={styles.subContainer}>
        ...
        <div className={styles.subsubContainer}>
          <div className={styles.filters} id="filters">
            <h3
              className={`${styles.mobileHeading} ${styles.mobileFilterHeading}`}
              id="mobileFilterTitle"
            >
              Filtreler
            </h3>
            <Filters />
          ...
          <div className={styles.eventCard} id="activeEvents">
            ...
            {events.length > 0 ? (
                ...
                if (index < limit) {
                  ...
                  return (
                    <EventCard
                      ...
                      url={item.url}
                      eventPlace={item.venue.name}
                      eventImg={item.poster_url}
              ...
              <div>
                Seçtiğiniz filtrelemeye göre uygun etkinlik bulunamamıştır!
              </div>
            )}
          </div>
        </div>
...
export async function getStaticProps() {
  const response = await fetch(
    "https://backend.etkinlik.io/api/v2/events?take=1000",
    {
      method: "GET",
      headers: {
